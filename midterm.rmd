...
pp_check(quail_brm, type = "stat", stat = 'mean', nsamples = 10)
...
```{r}
pp_check(quail_brm, type = "stat", stat = 'mean', nsamples = 100)
...
pp_check(quail_brm, type = "stat", stat = 'mean', nsamples = 300)
...
pp_check(quail_brm, type = "stat", stat = 'mean', nsamples = 500)
