...
<span style="color: green;">The residuals vs. fitted plot suggests no relationship between residuals and fitted values, as it is a nice cloud formation around the 0 line.</span>
...
qplot(m, log_lik, data=quail_m_profile, geom = "line")+
  geom_vline(xintercept=31.5, color = "red")+
  geom_vline(xintercept=32, color = "red")+
  geom_vline(xintercept=31.3, color = "blue")+
  geom_vline(xintercept=32.2, color = "blue")+
  theme_minimal()
